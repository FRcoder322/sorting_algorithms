...
{
    /* Function to swap a node with the node ahead of it */
...
{
    /* Function to swap a node with the node behind it */
...
{
    /* Function to perform cocktail shaker sort on a doubly-linked list */
